...
use super::{
    backup_v2_repo::{self, BackupV2Error, BackupV2Record},
...
fn into_insert_row(record: BackupV2Record) -> Option<InsertRow> {
    match record {
        BackupV2Record::Manifest(_) | BackupV2Record::End(_) => None,
        BackupV2Record::Role(value) => Some(InsertRow {
            table: "roles",
        ...
        BackupV2Record::User(value) => Some(InsertRow {
            table: "users",
            columns: &[
                "id",
                "email",
        ...
        BackupV2Record::Application(value) => Some(InsertRow {
            table: "applications",
            columns: &[
                "id",
                "name",
        ...
        BackupV2Record::RoleBinding(value) => Some(InsertRow {
            table: "role_bindings",
        ...
        BackupV2Record::Environment(value) => Some(InsertRow {
            table: "environments",
        ...
        BackupV2Record::ApiKey(value) => Some(InsertRow {
            table: "api_keys",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::AlertRule(value) => Some(InsertRow {
            table: "alert_rules",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::NotificationChannel(value) => Some(InsertRow {
        ...
        BackupV2Record::AlertDelivery(value) => Some(InsertRow {
        ...
        BackupV2Record::ImportRun(value) => Some(InsertRow {
            table: "import_runs",
            columns: &[
                "id",
                "source_type",
        ...
        BackupV2Record::Event(value) => Some(InsertRow {
            table: "events",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::MetricPoint(value) => Some(InsertRow {
            table: "metric_points",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::Log(value) => Some(InsertRow {
            table: "logs",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::ErrorGroup(value) => Some(InsertRow {
            table: "error_groups",
            columns: &[
                "id",
                "application_id",
        ...
        BackupV2Record::ErrorOccurrence(value) => Some(InsertRow {
        ...
        BackupV2Record::DailyAggregate(value) => Some(InsertRow {
        ...
        BackupV2Record::DailyRollup(value) => Some(InsertRow {
        ...
        BackupV2Record::AuditLog(value) => Some(InsertRow {
            table: "audit_log",
            columns: &[
                "id",
                "actor_user_id",
