...
fn table_specs() -> Vec<TableSpec> {
    vec![
        ...
        TableSpec {
            ...
            mapper: map_audit_log,
        },
    ]
}

fn map_role(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::Role(BackupRole {
        id: r.try_get("", "id")?,
        name: r.try_get("", "name")?,
...
fn map_user(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::User(BackupUser {
        id: r.try_get("", "id")?,
...
fn map_application(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::Application(BackupApplication {
        id: r.try_get("", "id")?,
        name: r.try_get("", "name")?,
        slug: r.try_get("", "slug")?,
...
fn map_role_binding(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::RoleBinding(BackupRoleBinding {
        id: r.try_get("", "id")?,
...
fn map_environment(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::Environment(BackupEnvironment {
        id: r.try_get("", "id")?,
...
fn map_api_key(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::ApiKey(BackupApiKey {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
...
fn map_alert_rule(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::AlertRule(BackupAlertRule {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
        name: r.try_get("", "name")?,
...
fn map_notification_channel(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::NotificationChannel(
...
fn map_alert_delivery(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::AlertDelivery(BackupAlertDelivery {
        id: r.try_get("", "id")?,
        ...
        next_attempt_at: r.try_get("", "next_attempt_at").ok(),
        created_at: r.try_get("", "created_at")?,
    }))
}
fn map_import_run(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::ImportRun(BackupImportRun {
        id: r.try_get("", "id")?,
        source_type: r.try_get("", "source_type")?,
        source_hash: r.try_get("", "source_hash")?,
        application_id: r.try_get("", "application_id")?,
        environment_id: r.try_get("", "environment_id")?,
        status: r.try_get("", "status")?,
        inserted: r.try_get("", "inserted")?,
        deduped: r.try_get("", "deduped")?,
        rejected: r.try_get("", "rejected")?,
        created_at: r.try_get("", "created_at")?,
    }))
}
fn map_event(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::Event(BackupEvent {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
        environment_id: r.try_get("", "environment_id")?,
        name: r.try_get("", "name")?,
...
fn map_error_group(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::ErrorGroup(BackupErrorGroup {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
        environment_id: r.try_get("", "environment_id")?,
        fingerprint: r.try_get("", "fingerprint")?,
        name: r.try_get("", "name")?,
        message_sample: r.try_get("", "message_sample")?,
        severity: r.try_get("", "severity")?,
        first_seen: r.try_get("", "first_seen")?,
        last_seen: r.try_get("", "last_seen")?,
        occurrences: r.try_get("", "occurrences")?,
        last_app_version: r.try_get("", "last_app_version").ok(),
        last_launcher_version: r.try_get("", "last_launcher_version").ok(),
        last_os: r.try_get("", "last_os").ok(),
        updated_at: r.try_get("", "updated_at")?,
    }))
}
fn map_error_occurrence(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::ErrorOccurrence(BackupErrorOccurrence {
        id: r.try_get("", "id")?,
        ...
        launcher_version: r.try_get("", "launcher_version").ok(),
        os: r.try_get("", "os").ok(),
        stack_trace: r.try_get("", "stack_trace").ok(),
        handled: r.try_get("", "handled").ok(),
        attributes: r.try_get("", "attributes")?,
        received_at: r.try_get("", "received_at")?,
    }))
}
fn map_daily_aggregate(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::DailyAggregate(BackupDailyAggregate {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
        environment_id: r.try_get("", "environment_id")?,
        day: r.try_get("", "day")?,
...
fn map_daily_rollup(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::DailyRollup(BackupDailyRollup {
        id: r.try_get("", "id")?,
        application_id: r.try_get("", "application_id")?,
        environment_id: r.try_get("", "environment_id")?,
        day: r.try_get("", "day")?,
        events: r.try_get("", "events")?,
        users: r.try_get("", "users")?,
        metrics: r.try_get("", "metrics")?,
        logs: r.try_get("", "logs")?,
...
fn map_audit_log(r: QueryResult) -> Result<BackupRecord, DbErr> {
    Ok(BackupRecord::AuditLog(BackupAuditLog {
        id: r.try_get("", "id")?,
...
pub fn manifest_summary(manifest: &BackupManifest) -> BTreeMap<&'static str, serde_json::Value> {
    BTreeMap::from([
        (
            "formatVersion",
            serde_json::Value::String(manifest.format_version.clone()),
        ),
        (
            "backupType",
            serde_json::Value::String(manifest.backup_type.clone()),
        ),
        ("exportedAt", serde_json::Value::from(manifest.exported_at)),
        (
            "containsSecrets",
            serde_json::Value::Bool(manifest.contains_secrets),
        ),
    ])
}
